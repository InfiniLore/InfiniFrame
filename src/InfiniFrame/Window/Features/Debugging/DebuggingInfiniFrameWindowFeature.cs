...
public sealed class DebuggingInfiniFrameWindowFeature(
...
) : IDebuggingInfiniFrameWindowFeature {

    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.IsDevToolsEnabled" />
    ...
    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.SupportsWebInspectorAttach" />
    public bool SupportsWebInspectorAttach => MacOsWebInspectorUtility.IsSupportedPlatform();

    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.IsWebInspectorEnabled" />
    public bool IsWebInspectorEnabled => window.Configuration.StartupParameters.WebInspectorEnabled;

    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.SupportsRemoteDebuggingEndpoint" />
    public bool SupportsRemoteDebuggingEndpoint => RemoteDebuggingUtility.IsSupportedPlatform();

    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.RemoteDebuggingPort" />
    ...
    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.Capabilities" />
    ...
    // Methods
    // -----------------------------------------------------------------------------------------------------------------
    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.EnableDevTools" />
    ...
    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.TryGetRemoteDebuggingEndpoint" />
    ...
    /// <inheritdoc cref="IDebuggingInfiniFrameWindowFeature.TryProbeEndpoint" />
    [SupportedOSPlatform("windows")]
    [SupportedOSPlatform("linux")]
