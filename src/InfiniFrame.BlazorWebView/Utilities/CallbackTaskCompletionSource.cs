...
public sealed class CallbackTaskCompletionSource<TCallback, TResult>(TCallback callback) : TaskCompletionSource<TResult>(TaskCreationOptions.RunContinuationsAsynchronously) {
