...
describe("BrowserInfiniFrameWindowFeature", () => {
    ...
    it("registers message handlers on construction", () => {
        expect(messaging.assignMessageReceivedHandler).toHaveBeenCalled();
    });
    ...
    it("enableContextMenu posts command", () => {
        feature.enableContextMenu(false);
        expect(messaging.sendMessageToHost).toHaveBeenCalled();
    });
    it("enableMediaAutoplay posts command", () => {
        feature.enableMediaAutoplay(true);
        expect(messaging.sendMessageToHost).toHaveBeenCalled();
    });
    it("setUserAgent posts command", () => {
        feature.setUserAgent("custom-agent");
        expect(messaging.sendMessageToHost).toHaveBeenCalled();
    });
    it("win32SetWebView2Path posts command", () => {
        feature.win32SetWebView2Path("C:/path");
        expect(messaging.sendMessageToHost).toHaveBeenCalled();
    });
    it("clearBrowserAutoFill posts command", () => {
    ...
    it("enableContextMenu posts with default true", () => {
        feature.enableContextMenu();
        expect(messaging.sendMessageToHost).toHaveBeenCalled();
    });
    it("enableMediaAutoplay posts with default true", () => {
        feature.enableMediaAutoplay();
        expect(messaging.sendMessageToHost).toHaveBeenCalled();
    });
