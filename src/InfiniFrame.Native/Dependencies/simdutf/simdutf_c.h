...
using simdutf_error_code = enum simdutf_error_code {
...
using simdutf_result = struct simdutf_result {
    simdutf_error_code error;
    size_t count; /* position of error or number of code units validated */
};

using simdutf_encoding_type = enum simdutf_encoding_type {
...
using simdutf_base64_options = enum simdutf_base64_options {
...
using simdutf_last_chunk_handling_options = enum simdutf_last_chunk_handling_options {
