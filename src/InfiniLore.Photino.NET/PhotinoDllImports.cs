...
public partial class PhotinoWindow
{
    ...
    [DllImport(DLL_NAME, CallingConvention = CallingConvention.Cdecl, SetLastError = true, CharSet = CharSet.Ansi)] private static extern IntPtr Photino_ctor(ref PhotinoNativeParameters parameters);
