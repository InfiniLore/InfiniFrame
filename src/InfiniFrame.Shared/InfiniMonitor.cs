...
public readonly record struct InfiniMonitor(Rectangle MonitorArea, Rectangle WorkArea, double Scale) {
    /// <summary>
    ///     Initializes a new instance of the <see cref="InfiniMonitor" /> struct using native structures.
    /// </summary>
