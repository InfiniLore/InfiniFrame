...
/// <param name="Label">The display text for the menu item. Required for <see cref="InfiniFrameMenuItemType.Normal"/> and <see cref="InfiniFrameMenuItemType.Submenu"/> items.</param>
