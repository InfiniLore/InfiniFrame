    ...
    [
      "@docusaurus/plugin-client-redirects",
      {
        redirects: [
          ...
          { from: ["/articles/concepts"], to: "/concepts/breaking-changes-from-photino" },
          ...
          { from: ["/articles/concepts/breaking-changes-from-photino", "/articles/concepts/breaking-changes-from-photino.html"], to: "/concepts/breaking-changes-from-photino" },
          ...
          { from: ["/api/cpp"], to: "/api" },
          { from: ["/api/cs", "/api/cs/index.html"], to: "/api" }
        ]
      }
    ]
  ],
